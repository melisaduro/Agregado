	...
	left outer join (
		...
		select 
			...
			case when sum([Count_Video_Resolucion_Video1])>0 then
				cast((sum(cast (left([avg Video Resolution_Video1],3) as int)*[Count_Video_Resolucion_Video1])/sum([Count_Video_Resolucion_Video1])) as varchar(10)) + ''p''
			...
			case when sum([Count_Video_Resolucion_Video2])>0 then
				cast((sum(cast (left([avg Video Resolution_Video2],3) as int)*[Count_Video_Resolucion_Video2])/sum([Count_Video_Resolucion_Video2])) as varchar(10)) + ''p''
			...
			case when sum([Count_Video_Resolucion_Video3])>0 then
				cast((sum(cast (left([avg Video Resolution_Video3],3) as int)*[Count_Video_Resolucion_Video3])/sum([Count_Video_Resolucion_Video3])) as varchar(10)) + ''p''
			...
			case when sum([Count_Video_Resolucion_Video4])>0 then
				cast((sum(cast (left([avg Video Resolution_Video4],3) as int)*[Count_Video_Resolucion_Video4])/sum([Count_Video_Resolucion_Video4])) as varchar(10)) + ''p''
		...
		from '+@bbdd+'.dbo.lcc_aggr_sp_MDD_Data_youtube_hd_Video'+@sheet+ '
		where entidad like '''+@entidad+''' and meas_date='''+@date_reporting+''' and Report_Type='''+@report_type+''' 
		group by Entidad,mnc,meas_date		


	)ytb on (dl_ce.entidad=ytb.Entidad and dl_Ce.mnc=ytb.mnc and dl_ce.date_reporting=ytb.meas_date)
